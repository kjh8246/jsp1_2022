...
<body>
	<!-- form_test.html 에서 사용자가 데이터 입력 후  submit 실행 하면 url :
		 ...
		 ?data1=123&data2=abcd 은 query string이라고 합니다. data1,data2는 사용자 입력 파라미터
	     request_test.jsp 에서는 위의 데이터를 전달 받습니다.
	 -->
	 <%
	 		//request 는 jsp의 객체입니다.(내장객체:선언하지 않고 자동으로 쓸수 있는 객체)
	 		...
	 		/* 결론 : 사용자 입력오류를 제거하기 위해 1)프론드단에서 자바스크립트로 유효성 검사하기
							2) 서버단 에서 try~catch 로 처리하기 */
